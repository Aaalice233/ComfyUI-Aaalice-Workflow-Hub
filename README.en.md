...
- The Activity panel uses five stage segments to show the current phase of publishing or pending-publication resumption, while retaining operation status, logs, and errors.
