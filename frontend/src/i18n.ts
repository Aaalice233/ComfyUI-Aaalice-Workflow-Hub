...
const messages = {
  zh: {
    ...
    stageQueued: "等待处理", stageInstalling: "正在安装插件", stageDownloading: "正在下载", stageVerifying: "正在校验",
    ...
    confirmEnvironment: "我确认使用 Git 串行克隆或切换所选插件", execute: "执行依赖计划",
    ...
    gitCommitVersion: "Git 提交 · {version}", gitRevisionUnavailable: "未检测到 Git 提交",
  ...
  en: {
    ...
    stageQueued: "Queued", stageInstalling: "Installing plugins", stageDownloading: "Downloading", stageVerifying: "Verifying",
    ...
    confirmEnvironment: "I confirm Git may clone or switch the selected plugins serially", execute: "Apply dependency plan",
    ...
    gitCommitVersion: "Git commit · {version}", gitRevisionUnavailable: "No Git commit detected",
