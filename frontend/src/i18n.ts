...
const messages = {
  zh: {
    ...
    chooseRepository: "请选择 GitHub 仓库", noAuthorizedRepositories: "没有已授权的仓库",
  ...
  en: {
    ...
    chooseRepository: "Choose a GitHub repository", noAuthorizedRepositories: "No authorized repositories",
